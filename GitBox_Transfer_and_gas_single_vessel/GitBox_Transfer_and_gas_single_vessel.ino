...
//Times are calculated by pumping 16% of reactor content
//with capacity = 0.78ml/min for 6-channel pump
//A total of 231 seconds to transfer 3 ml
//The first 60 seconds of pumping
//clears everything from last pumping (so no sample collection)
//For this, we just need food to colon and colon to waste
//Feed every 4 hours. All transfers will happen at exact same time, transfering
// 1/10 of the total content
//This ensures an overall 40 hours retention time
...
//so we fill the tubes, only for the first time
